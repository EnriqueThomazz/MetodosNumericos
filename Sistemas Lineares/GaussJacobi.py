def GaussJacobi(matriz, chute_inicial, precisao):
    # Verificar convergencia pelo Critério das Linhas
    ...
    parou = False
    while not parou:
        aprox_atual = [None] * len(matriz) # inicializando vetor
